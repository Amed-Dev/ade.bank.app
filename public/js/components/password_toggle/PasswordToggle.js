...
function createSvgNode(svgCode) {
...
export class PasswordToggle {
  ...
  togglePasswordVisibility() {
    if (this.passwordInput.type === "password") {
      ...
      const eyeSlashedNode = createSvgNode(eyeSlashedSvg);
      this.toggleButton.replaceChild(
        eyeSlashedNode,
        this.toggleButton.querySelector("svg")
      );
    } else {
      this.passwordInput.type = "password";
      const eyeOpenNode = createSvgNode(eyeOpenSvg);
      this.toggleButton.replaceChild(
        eyeOpenNode,
        this.toggleButton.querySelector("svg")
      );
